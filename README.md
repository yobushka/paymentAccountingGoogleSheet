...
Все остальные листы вспомогательные и собираются автоматически из этих трёх: «Баланс», «Детализация», «Сводка», «Lists» (скрытый), «Инструкция». Лист «Участие» — опциональный фильтр участия (см. ниже); если он пуст, участвуют все активные семьи.
...
- Сборы: Название, Статус (Открыт/Закрыт), Начисление, Параметр суммы, Фиксированный x, collection_id (авто), Ссылка на гуглдиск (опц.)
 - Сборы: Название, Статус (Открыт/Закрыт), Начисление, Параметр суммы, Фиксированный x, collection_id (авто), Ссылка на гуглдиск (опц.), Закупка из средств (опц.), Возмещено (опц.)
